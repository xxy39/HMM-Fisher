########################################################
# count.T
# R code to count the number of transitions in each of the 9 types
# 
# The 1,2,3 corresponds to states 0,1/2,1, which is not methylated, partly methyalated, and fully methylated respectively
# There are 9 possible transitions between the states.
#########################################################
